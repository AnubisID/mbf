...
def tampilhasil(akun,sandi,data):
	...
	i = inputD('[?] Tidak Puas dengan Hasil,bikin sendiri -_- (y/t)',['Y','T'])
	if i.upper() == 'Y':
		return crack(data)
	else:
		return menu()
...
def login():
	...
	if 'save-device' in url or 'm_sess' in url:
		...
		cetak('!h[*] semoga anda tidak kembali kembali ke masa lalu!!')
		log = 1
...
def idteman():
	...
	if i.upper() == 'Y':
		...
		return menu()
def menu():
	cetak("\n           !h.-.-..\n          /+/++//\n         /+/++//\n  !k*   !k* !h/+/++//\n   \ /  |/__//\n !h{!mX!h}v{!mX!h}!0!b|!cMBF!b|==========.\n   !h(!m'!h)!0  !h/'|'\           !b\\\n       !h/  \  \          !b'\n       !h\_  \_ \_   !k___!mMBF !cselamat data anda terhapu -_-!k___\n\n !m* !bHARGAIN INI GOBLOK PUSING GUA BIKIN NYA ASW\n !m* contac wa- 085332138743\n !m* !cP3RC1L\n !m* !phttps://github.com/percil021\n!k.======================.\n|!h  AMBIL !mID!h DARI.....  !k|\n'======================'\n!k#!p1 !hDAFTAR TEMAN\n!k#!p2 !hANGGOTA GROUP\n!k#!p3 !mKELUAR...")
...
install_browser()
menu()
maaf_anda_tidak_dapat_kembali_ke_masalalu()
#
#
#
#